...
int main() {
	...
	for(int dict_pos = 4; dict_pos < 256; dict_pos++) {
		...
		cout<<"                        n_largest = 3'd5;"<<endl;
		cout<<"                        n_largest_pos = 8'd"<<dict_pos-4<<";"<<endl;
		cout<<"                    end"<<endl;
		cout<<"                end"<<endl;
	}
	...
	for(int dict_pos = 3; dict_pos < 256; dict_pos++) {
		...
		cout<<"                        n_largest = 3'd4;"<<endl;
		cout<<"                        n_largest_pos = 8'd"<<dict_pos-3<<";"<<endl;
		cout<<"                    end"<<endl;
		cout<<"                end"<<endl;
	}
	...
	for(int dict_pos = 2; dict_pos < 256; dict_pos++) {
		...
		cout<<"                        n_largest = 3'd3;"<<endl;
		cout<<"                        n_largest_pos = 8'd"<<dict_pos-2<<";"<<endl;
		cout<<"                    end"<<endl;
		cout<<"                end"<<endl;
	}
	...
	for(int dict_pos = 1; dict_pos < 256; dict_pos++) {
		...
		cout<<"                        n_largest = 3'd2;"<<endl;
		cout<<"                        n_largest_pos = 8'd"<<dict_pos-1<<";"<<endl;
		cout<<"                    end"<<endl;
		cout<<"                end"<<endl;
	}
